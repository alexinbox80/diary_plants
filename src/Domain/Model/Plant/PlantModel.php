...
class PlantModel implements AttachableModelInterface
{
    ...
    {
        return [
            'id' => 'table.plant.header.id',
            'group_id' => 'table.plant.header.group_id',
            'group_title' => 'table.plant.header.group_title',
            'oid' => 'table.plant.header.oid',
            'img_gallery' => 'table.plant.header.img_gallery',
            'title' => 'table.plant.header.title',
            'room' => 'table.plant.header.room',
            'is_shown' => 'table.plant.header.is_shown',
            'description' => 'table.plant.header.description',
            'img_qr_code_link' => 'table.plant.header.img_qr_code_link',
            'purchase_date' => 'table.plant.header.purchase_date',
            'vaccination_date' => 'table.plant.header.vaccination_date',
            'planting_date' => 'table.plant.header.planting_date',
            'seller' => 'table.plant.header.seller',
            'nursery' => 'table.plant.header.nursery',
            'price' => 'table.plant.header.price',
            'shipping_cost' => 'table.plant.header.shipping_cost',
            'packaging_cost' => 'table.plant.header.packaging_cost',
            'soil' => 'table.plant.header.soil',
            'is_sold' => 'table.plant.header.is_sold',
            'selling_date' => 'table.plant.header.selling_date',
            'selling_price' => 'table.plant.header.selling_price',
            'comment' => 'table.plant.header.comment',
            'created_at' => 'table.plant.header.created_at',
            'updated_at' => 'table.plant.header.updated_at'
        ];
    }
    ...
    public static function getProfileHeaderRu(): array
    {
        return [
            ...
            'selling_price' => 'table.plant.header.selling_price',
            'comment' => 'table.plant.header.comment',
            'usage_watering' => 'table.plant.header.usage_watering',
            'usage_fertilizer' => 'table.plant.header.usage_fertilizer',
            'usage_pest' => 'table.plant.header.usage_pest',
            'usage_stimulant' => 'table.plant.header.usage_stimulant',
            'repottings' => 'table.plant.header.repottings',
            'offsprings' => 'table.plant.header.offsprings',
            //'created_at' => 'table.plant.header.created_at',
            //'updated_at' => 'table.plant.header.updated_at'
        ];
    }
