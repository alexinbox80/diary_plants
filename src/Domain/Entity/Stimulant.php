...
class Stimulant extends Preparation implements EntityInterface, AttachableInterface, GroupOwnedInterface, HasMetaTimestampsInterface, SoftDeletableInterface
{
    ...
    #[ORM\ManyToOne(targetEntity: Group::class, cascade: ['all'], inversedBy: 'stimulants')]
