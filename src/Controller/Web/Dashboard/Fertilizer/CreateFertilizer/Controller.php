...
final class Controller extends AbstractController
{
    ...
    #[Route(path: '/dashboard/fertilizers/create', name: 'dashboard.fertilizers.create', methods: ['GET', 'POST'])]
    public function __invoke(Request $request): Response
    {
        ...
        return $this->render('dashboard/fertilizer/create.html.twig', $result);
    }
}
