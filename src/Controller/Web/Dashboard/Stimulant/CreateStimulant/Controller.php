...
class Controller extends AbstractController
{
    ...
    #[Route(path: '/dashboard/stimulants/create', name: 'dashboard.stimulants.create', methods: ['GET', 'POST'])]
    public function __invoke(Request $request): Response
    {
        ...
        return $this->render('dashboard/stimulant/create.html.twig', $result);
    }
}
