...
final class Version20250825201143 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fertilizer (
                    ...
                    amount INT NOT NULL,
                    application_rate VARCHAR(50) NULL,
        ...
        $this->addSql('CREATE TABLE repotting (
                    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
                    group_id BIGINT NOT NULL,
                    plant_id BIGINT NOT NULL,
                    repotted_at TIMESTAMP(0) WITH TIME ZONE NOT NULL,
                    substrate VARCHAR(1024) DEFAULT NULL,
                    comment TEXT DEFAULT NULL,
                    type VARCHAR(50) NOT NULL,
                    pot_material VARCHAR(50) NOT NULL,
                    pot_size VARCHAR(32) NOT NULL,
                    created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL,
                    updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL,
                    deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL,
                    PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE analytic (
                    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
                    plant_id BIGINT DEFAULT NULL,
                    group_id BIGINT NOT NULL,
                    count INT NOT NULL,
                    average_days DOUBLE PRECISION NOT NULL,
                    created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL,
                    updated_at TIMESTAMP(0) WITH TIME ZONE NOT NULL,
                    deleted_at TIMESTAMP(0) WITH TIME ZONE DEFAULT NULL,
                    PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE "user_message" (
                    id BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
                    user_id INT DEFAULT NULL,
        ...
        $this->addSql('ALTER TABLE repotting ADD CONSTRAINT repotting__plant_id__fk  FOREIGN KEY (plant_id) REFERENCES plant (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE repotting ADD CONSTRAINT repotting__group_id__fk  FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        ...
        $this->addSql('ALTER TABLE analytic ADD CONSTRAINT analytic__plant_id__fk FOREIGN KEY (plant_id) REFERENCES plant (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE analytic ADD CONSTRAINT analytic__group_id__fk FOREIGN KEY (group_id) REFERENCES "group" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE analytic DROP CONSTRAINT analytic__plant_id__fk');
        $this->addSql('ALTER TABLE analytic DROP CONSTRAINT analytic__group_id__fk');

        $this->addSql('DROP TABLE attachment');
        $this->addSql('DROP TABLE fertilizer');
        $this->addSql('DROP TABLE offspring');
        $this->addSql('DROP TABLE repotting');
