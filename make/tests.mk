...
test: app-test entity-test model-test exception-test vo-test service-test event-test cli-test form-test web-test infra-test func-test repo-test
...
exception-test:
	...
	$(PHPUNIT) tests/Unit/Domain/Exception
